...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191222090341_CreateProductTable")]
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("55238903-d5f7-4d8f-aefc-d73898fc5b76"),
                            CreatedDate = new DateTime(2019, 12, 22, 16, 3, 41, 599, DateTimeKind.Local).AddTicks(5624),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("2e66f5dd-e3cc-4491-8689-ae8b650eb82d"),
                            CreatedDate = new DateTime(2019, 12, 22, 16, 3, 41, 601, DateTimeKind.Local).AddTicks(3339),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("9aa65568-9af3-49fb-a04a-f461444fbf54"),
                            CreatedDate = new DateTime(2019, 12, 22, 16, 3, 41, 601, DateTimeKind.Local).AddTicks(3479),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
