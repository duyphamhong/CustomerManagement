...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191229070017_CreateProductOrders2")]
    partial class CreateProductOrders2
    {
            ...
            modelBuilder.Entity("CustomerManagement.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("51e8b128-6279-43af-8618-c015decf0a9e"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 459, DateTimeKind.Local).AddTicks(1949),
                            Name = "Car"
                        },
                        new
                        {
                            Id = new Guid("08dcee5e-ad73-4fd3-aa44-1e1ebbe641f1"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 461, DateTimeKind.Local).AddTicks(223),
                            Name = "Bycicle"
                        },
                        new
                        {
                            Id = new Guid("9cf4a8c8-b16d-4619-9e25-e020f651c18e"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 461, DateTimeKind.Local).AddTicks(355),
                            Name = "Motor"
                        });
                });
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a576add8-2bbe-4b30-bca6-f900822aa5a9"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 461, DateTimeKind.Local).AddTicks(8649),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("08cdc182-59d3-4c2d-ac09-707d943e28e2"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 462, DateTimeKind.Local).AddTicks(232),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("4b05ab8d-b0a1-43f0-b85a-0eadd2de38e2"),
                            CreatedDate = new DateTime(2019, 12, 29, 14, 0, 17, 462, DateTimeKind.Local).AddTicks(287),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
