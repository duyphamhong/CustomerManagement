...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191229023608_CreateCategoryRealtions")]
    partial class CreateCategoryRealtions
    {
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7d0f422e-b9b9-4c28-917f-52edcf8c4897"),
                            CreatedDate = new DateTime(2019, 12, 29, 9, 36, 6, 657, DateTimeKind.Local).AddTicks(786),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("7af876e2-4071-4054-ba9d-b7b3efd3fbdd"),
                            CreatedDate = new DateTime(2019, 12, 29, 9, 36, 6, 667, DateTimeKind.Local).AddTicks(2396),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("4b80a7ae-f8f0-4ecf-8c25-acde5ce0c960"),
                            CreatedDate = new DateTime(2019, 12, 29, 9, 36, 6, 667, DateTimeKind.Local).AddTicks(3395),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
