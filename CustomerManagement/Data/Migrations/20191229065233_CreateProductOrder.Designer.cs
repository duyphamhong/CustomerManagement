...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191229065233_CreateProductOrder")]
            ...
            modelBuilder.Entity("CustomerManagement.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e083f00e-58ba-4298-89ba-85ba056ec46c"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 795, DateTimeKind.Local).AddTicks(6700),
                            Name = "Car"
                        },
                        new
                        {
                            Id = new Guid("8eeaf317-ac9e-46cb-96ad-b86335668f8b"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 797, DateTimeKind.Local).AddTicks(3593),
                            Name = "Bycicle"
                        },
                        new
                        {
                            Id = new Guid("ddfa69d5-1ff1-4c97-9d9b-2f9cc1c85210"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 797, DateTimeKind.Local).AddTicks(3717),
                            Name = "Motor"
                        });
                });
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2492e2a5-5e77-478a-b66e-1a2a3c8e7dc9"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 798, DateTimeKind.Local).AddTicks(1031),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("337a7834-368d-4a03-982e-bce623cb3d15"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 798, DateTimeKind.Local).AddTicks(2556),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("d410e683-7a5f-4436-aa89-3915bb1c2c08"),
                            CreatedDate = new DateTime(2019, 12, 29, 13, 52, 32, 798, DateTimeKind.Local).AddTicks(2610),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
