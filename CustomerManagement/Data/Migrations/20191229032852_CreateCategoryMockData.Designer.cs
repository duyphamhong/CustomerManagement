...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191229032852_CreateCategoryMockData")]
    partial class CreateCategoryMockData
    {
            ...
            modelBuilder.Entity("CustomerManagement.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e427418b-d05d-4136-9c60-bf45ab7e9bf0"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 925, DateTimeKind.Local).AddTicks(5913),
                            Name = "Car"
                        },
                        new
                        {
                            Id = new Guid("f99d255c-1d9d-4151-ad20-3865ad03412c"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 927, DateTimeKind.Local).AddTicks(3256),
                            Name = "Bycicle"
                        },
                        new
                        {
                            Id = new Guid("3ac643d8-6704-4fab-88f4-fc96ed82e502"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 927, DateTimeKind.Local).AddTicks(3376),
                            Name = "Motor"
                        });
                });
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f82df266-9fb3-44fe-93d7-509933b53c6a"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 927, DateTimeKind.Local).AddTicks(3960),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("3a4f1dad-4ed1-48a7-b8a5-a30563ff8db4"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 927, DateTimeKind.Local).AddTicks(5446),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("306a21aa-deb2-407c-b6f2-bbff9d7394c7"),
                            CreatedDate = new DateTime(2019, 12, 29, 10, 28, 51, 927, DateTimeKind.Local).AddTicks(5499),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
